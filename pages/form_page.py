...
class FormPage(BasePage):
    def __init__(self, driver):
        ...
        # Добавляем для проверки валидации
        self.user_form = WebElement(driver, '#userForm')

        #Для задания "State and City":
        self.state = WebElement(driver, '#state')
        self.city = WebElement(driver, '#city')
        self.state_dropdown = WebElement(driver, '//*[@id="state"]/div/div[1]', 'xpath')
        self.city_dropdown = WebElement(driver, '//*[@id="city"]/div/div[1]', 'xpath')